        ...
        <div class="row">
            ...
            <div class="about-author">
                <div class="about-author-left">
                    <a title="<?php echo html_escape($post_user->username); ?>" href="<?php echo generate_profile_url($post_user->slug); ?>" class="author-link">
                ...
                <div class="about-author-right">
                    <div class="about-author-row">
                        <p>
                            <strong>
                                <a title="<?php echo html_escape($post_user->username); ?>" href="<?php echo generate_profile_url($post_user->slug); ?>" class="author-link"> <?php echo html_escape($post_user->username); ?> </a>
                            </strong>
                        </p>
                    </div>
