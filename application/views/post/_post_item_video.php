...
<div class="video-item-small<?php echo check_post_img($post, 'class'); ?>">
    <div class="VideoPostImg"><div class="videoIcon"><a href="<?php echo generate_post_url($post); ?>"<?php post_url_new_tab($this, $post); ?>><i class="icon-play-circle"></i></a></div>
  ...
  <a  title="<?php echo html_escape($post->title); ?>" href="<?php echo generate_post_url($post); ?>"<?php post_url_new_tab($this, $post); ?>>
	...
	<a  title="<?php echo html_escape($category->name); ?>" href="<?php echo generate_category_url_by_id($post->category_id); ?>">
