        ...
        <div class="row">
            <div class="col-sm-12 page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><?php echo html_escape($topic->topic); ?></li>
                </ol>
            </div>
            ...
            <div id="content" class="col-sm-8">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="page-title"><span> Topic:</span>&nbsp;<strong><?php echo html_escape($topic->topic); ?></strong></h1>
                    </div>
                    <?php $count = 0; ?>
            ...
            <div id="sidebar" class="col-sm-4">
                ...
                <?php //$this->load->view('partials/home_breaking_sidebar', $breaking_news); ?>
                    ...
                    if($category->name_slug=='other-stories'){
