    ...
    <div class="col-sm-8">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12 col-profile">
                            <img src="<?php echo get_user_avatar($user->avatar); ?>" alt="" class="thumbnail img-responsive img-update" style="max-width: 300px;">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <label><?php echo trans("form_password"); ?> <small>(Optional)</small></label>
                    <input type="password" name="password" class="form-control auth-form-input" placeholder="<?php echo trans("form_password"); ?>" value="">
                </div>    
                <div class="form-group">
                ...
                <hr>
                <div class="form-group">
                    <label><?php echo trans('balance'); ?></label>
                    <input type="text" class="form-control form-input price-input" name="balance" placeholder="<?php echo trans('balance'); ?>"
                           value="<?php echo $user->balance; ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="form-group">
                    <label><?php echo trans('total_pageviews'); ?></label>
                    <input type="text" class="form-control form-input" name="total_pageviews" placeholder="<?php echo trans('total_pageviews'); ?>"
                           value="<?php echo $user->total_pageviews; ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
            </div>
            <!-- /.box-body -->
