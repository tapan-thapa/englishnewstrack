        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select id="categories" class="form-control" name="parent_id">
                        ...
                        <?php foreach ($parent_categories as $item) : ?>
                            <?php if($item['id'] == $category->id) continue; ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="<?php echo trans("category_name"); ?>" value="<?php echo html_escape($category->name); ?>" maxlength="200" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name_slug" placeholder="<?php echo trans("slug"); ?>" value="<?php echo html_escape($category->name_slug); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                
                <div class="form-group">
                    <label class="control-label"><?php echo trans('title'); ?> (<?php echo trans('meta_tag'); ?>)</label>
                    <input type="text" class="form-control" name="title" placeholder="<?php echo trans('title'); ?> (<?php echo trans('meta_tag'); ?>)" value="<?php echo html_escape($category->title); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>

                <div class="form-group">
                    <label class="control-label"><?php echo trans('description'); ?> (<?php echo trans('meta_tag'); ?>)</label>
                    <input type="text" class="form-control" name="description" placeholder="<?php echo trans('description'); ?> (<?php echo trans('meta_tag'); ?>)" value="<?php echo html_escape($category->description); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>

                <div class="form-group">
                    <label class="control-label"><?php echo trans('keywords'); ?> (<?php echo trans('meta_tag'); ?>)</label>
                    <input type="text" class="form-control" name="keywords" placeholder="<?php echo trans('keywords'); ?> (<?php echo trans('meta_tag'); ?>)" value="<?php echo html_escape($category->keywords); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group my-colorpicker">
                        <input type="text" class="form-control" name="color" maxlength="200" value="<?php echo html_escape($category->color); ?>" placeholder="<?php echo trans('color'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="category_order" placeholder="<?php echo trans('order'); ?>" value="<?php echo html_escape($category->category_order); ?>" min="1" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                </div>

                <div class="form-group">
                    <label>Home Order</label>
                    <input type="number" class="form-control" name="home_order" placeholder="Home Order" value="<?php echo html_escape($category->home_order); ?>" min="1" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                </div>
                <div class="form-group">
                    <label>Home Stories Limit (between 1 and 20)</label>
                    <input type="number" class="form-control" name="home_limit" placeholder="Home Limit" value="<?php echo html_escape($category->home_limit); ?>" min="1" max="20" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                </div>

                <div class="form-group">
                    <label>Home CSS Class Name</label>
                    <input type="text" class="form-control" name="home_css_name" placeholder="CSS Name" value="<?php echo html_escape($category->home_css_name); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> >
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="rb_show_at_cms_1" name="show_at_cms" value="1" class="square-purple" <?php echo ($category->show_at_cms == '1') ? 'checked' : ''; ?>>
                            <label for="rb_show_on_menu_1" class="cursor-pointer"><?php echo trans('yes'); ?></label>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="rb_show_at_cms_2" name="show_at_cms" value="0" class="square-purple" <?php echo ($category->show_at_cms != '1') ? 'checked' : ''; ?>>
