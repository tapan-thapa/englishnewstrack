        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content settings-tab-content">
                ...
                <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="form-group">
                        <label class="control-label"><?php echo trans('cookie_prefix'); ?></label>
                        <input type="text" class="form-control max-600" name="cookie_prefix" placeholder="<?php echo trans('cookie_prefix'); ?>"
                               value="<?php echo html_escape($this->general_settings->cookie_prefix); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required>
                    </div>
