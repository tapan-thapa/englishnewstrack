...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/css/AdminLTE.min.css?v1">
    <!-- AdminLTE Skins -->
    ...
    <!-- Datetimepicker css -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/css/custom-1.9.css?v5">
    <!-- RTL -->
        ...
        <section class="sidebar sidebar-scrollbar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <?php if (check_user_permission('add_post')): ?>
					...
					<li class="nav-post-format">
                        <a href="<?php echo admin_url(); ?>breaking-news-list">
                            <i class="fa fa-file"></i>
                    ...
                    <li class="treeview<?php is_admin_nav_active(['posts', 'slider-posts', 'featured-posts', 'breaking-news', 'recommended-posts', 'pending-posts', 'scheduled-posts', 'drafts', 'update-post','special-posts','trending-posts']); ?>">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if (check_user_permission('manage_all_posts')): ?>
                                ...
                                <li class="nav-featured-posts">
                                    <a href="<?php echo admin_url(); ?>featured-posts?show=30"><?php echo trans("featured_posts"); ?></a>
                                </li>
								<li class="nav-special-posts">
                                    <a href="<?php echo admin_url(); ?>special-posts">Special Posts</a>
                                </li>
								<li class="nav-trending-posts">
                                    <a href="<?php echo admin_url(); ?>trending-posts">Trending Posts</a>
                                </li>
                               <!-- <li class="nav-breaking-news">
                                ...
                                <li class="nav-live-news">
                                    <a href="<?php echo admin_url(); ?>live-news">Live Blogs</a>
                                </li>
                                <li class="nav-web-story">
                                    <a href="<?php echo admin_url(); ?>webstories">Webstories</a>
                                </li>
                            <?php endif; ?>
                            ...
                            <li class="nav-drafts">
                                <a href="<?php echo admin_url(); ?>add-quick-links"><?php echo "Add Quick Lnks"; ?></a>
                            </li>
                            <li class="nav-drafts">
                                <a href="<?php echo admin_url(); ?>add-tags"><?php echo "Add Trending Tags"; ?></a>
                            </li>
                        </ul>
                    </li>
                <?php endif; ?>
                ...
                <?php endif; ?>
                <li class="nav-drafts">
                    <a href="<?php echo admin_url(); ?>tags-library-listing"><i class="fa fa-file"></i><?php echo "Tags Library"; ?></a>
                </li>
                <?php if (check_user_permission('categories')): ?>
                    <li class="treeview<?php is_admin_nav_active(['categories', 'subcategories', 'update-category', 'add-category', 'update-subcategory']); ?>">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="nav-add-category">
                                <a href="<?php echo admin_url(); ?>add-category"><?php echo trans("add_categories"); ?></a>
                            </li>
