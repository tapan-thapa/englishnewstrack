...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text-area inputwordcount"
                      name="title_slug" id="title_slug" word-json='{"word":25,"showID":"title_slug_word","show":1}' placeholder="<?php echo trans('slug'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required><?php echo old('title_slug'); ?></textarea>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text-area"
                      name="keywords" placeholder="<?php echo trans('keywords'); ?> (<?php echo trans('meta_tag'); ?>)" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>><?php echo old('keywords'); ?></textarea>
