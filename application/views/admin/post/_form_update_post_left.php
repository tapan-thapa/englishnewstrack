    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text-area inputwordcount"
                      name="title" id="wr_input_post_title" maxlength="120" word-json='{"word":25,"showID":"wr_input_post_title_word","show":1}' placeholder="<?php echo trans('title'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required><?php echo html_escape($post->title); ?></textarea>
            <!-- <input type="text"  maxlength="120" class="form-control dev-raj" name="title" placeholder="<?php echo trans('title'); ?>"
        ...
        <div class="form-group">
            ...
            <input id="tags_search" type="text" name="tags" class="form-control tags" value="<?php echo html_escape($tags); ?>"/>
