...
<div class="row">
    <div class="col-sm-12">
        ...
        <input type="hidden" name="post_type" value="live_post">
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="form-post">
                    <div class="form-post-left">
                        <div class="row">
                            <div class="col-sm-12">
                                <?php $this->load->view("admin/post/_form_update_live_post_left"); ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <?php $this->load->view("admin/post/live/_live_history", ['post' => $post, 'post_type' => $post->post_type]); ?>
