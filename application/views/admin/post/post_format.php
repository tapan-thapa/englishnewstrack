...
<div class="row">
    <div class="col-sm-12 post-format-container">
        ...
        <?php endif; ?>
        <div class="col-xs-12 col-sm-4 col-add-post">
            <a href="<?php echo admin_url(); ?>add-post?type=webstory">
                <div class="item">
                    <div class="item-icon">
                        <i class="icon-article"></i>
                    </div>
                    <h5 class="title">Webstories</h5>
                </div>
            </a>
        </div>
        ...
        <?php endif; ?>
        <div class="col-xs-12 col-sm-4 col-add-post">
                <a href="<?php echo admin_url(); ?>add-post?type=live_post">
                    <div class="item">
                        <div class="item-icon">
                            <i class="icon-article"></i>
                        </div>
                        <h5 class="title">Live Blog</h5>
                    </div>
                </a>
            </div>
            <?php if ($this->general_settings->post_format_audio == 1): ?>
            <div class="col-xs-12 col-sm-4 <?php echo ($format_count == 6) ? '' : ''; ?>col-add-post">
        ...
        <!-- <div class="col-xs-12 col-sm-4 col-add-post">
            <a href="<?php //echo admin_url(); ?>add-post?type=short_videos">
                <div class="item">
                        <div class="item-icon">
                            <i class="icon-video"></i>
                        </div>
                    <h5 class="title">Short Videos</h5>
                </div>
            </a>
        </div> -->
    </div>
