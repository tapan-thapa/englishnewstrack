            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-result-text" id="input_result_text_<?php echo $result_unique_id; ?>" data-result-id="<?php echo $result_unique_id; ?>" name="result_title[]" placeholder="<?php echo trans("title"); ?>" value="" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
                        <label class="control-label"><?php echo "URL" ?></label>
                        <input type="text" class="form-control input-result-text" id="input_result_url_<?php echo $result_unique_id; ?>" data-result-id="<?php echo $result_unique_id; ?>" name="result_url[]" placeholder="<?php echo "URL"; ?>" value="" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>
                </div>
                <div class="col-sm-12">
                    ...
                    <div class="left">
                            ...
                            <div id="post_list_item_image_container_<?php echo $result_unique_id; ?>">
                                ...
                                <div class="list-item-image-container">
                                        ...
                                        <a class='btn-select-image' data-toggle="modal" data-target="#file_manager_image" data-post-type="webstory" data-image-type="list_item" data-list-item-id="<?php echo $result_unique_id; ?>" data-is-update="0">
                                            <div class="btn-select-image-inner">
                                                <i class="icon-images"></i>
                                                <button class="btn"><?php echo trans("select_image"); ?></button>
                                            </div>
