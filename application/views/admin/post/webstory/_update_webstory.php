...
<div id="panel_quiz_<?php echo $result->id; ?>" class="panel panel-default panel-quiz-result" data-result-id="<?php echo $result->id; ?>">
    <div class="panel-heading">
        ...
        <div class="btn-group btn-group-post-list-option" role="group">
            <button type="button" class="del-vin btn btn-default" onclick="delete_webstory_database('<?php echo $result->id; ?>','<?php echo trans("confirm_result"); ?>');"><i class="fa fa-trash"></i></button>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-result-text" data-result-id="<?php echo $result->id; ?>" name="result_url_<?php echo $result->id; ?>" placeholder="<?php echo "URL"; ?>" value="<?php echo html_escape($result->url); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>
                </div>
                <div class="col-sm-12">
                            ...
                            <div id="post_list_item_image_container_<?php echo $result->id; ?>">
                                <div class="list-item-image-container">
                                    <?php if (!empty($result->image_path)):
                                        ...
                                        <a class="btn btn-danger btn-sm btn-delete-selected-file-image btn-delete-selected-list-item-image" data-result-id="<?php echo $result->id; ?>" data-list-item-id="<?php echo $result->id; ?>"   data-post-type="webstory" data-is-update="1">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <a class="btn-select-image" data-toggle="modal" data-post-type="webstory" data-target="#file_manager_image" data-image-type="list_item" data-list-item-id="<?php echo $result->id; ?>" data-is-update="1">
