    ...
    <div class="box-body">
        ...
        <?php $this->load->view('admin/includes/_messages'); ?>
		 ...
		 <!-- <div class="form-group">
            ...
            <input type="text" id="wr_input_post_topic" class="form-control" name="topic" placeholder="Topic"
                   value="<?php //echo old('topic'); ?>" <?php //echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> >
        </div> -->
		
		<!-- <div class="form-group">
            <label class="control-label">Headline</label>
            <input type="text" id="wr_input_post_headline" class="form-control" name="headline" placeholder="Headline"
                   value="<?php //echo old('headline'); ?>" <?php //echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> >
        </div> -->
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text-area inputwordcount"
                      name="title" maxlength="120" id="wr_input_post_title" word-json='{"word":25,"showID":"wr_input_post_title_word","show":1}' placeholder="<?php echo trans('title'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required><?php echo old('title'); ?></textarea>

            <!-- <input type="text" maxlength="120" id="wr_input_post_title" class="form-control" name="title" placeholder="<?php echo trans('title'); ?>"
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text-area inputwordcount"
                      name="title_slug" id="title_slug" placeholder="<?php echo trans('slug'); ?>" word-json='{"word":25,"showID":"title_slug_word","show":1}' <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required><?php echo old('title_slug'); ?></textarea>

            <!-- <input type="text" class="form-control" name="title_slug" placeholder="<?php echo trans('slug'); ?>"
                   value="<?php echo old('title_slug'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required> -->
        </div>
        ...
        <div class="form-group">
            ...
            <textarea class="tinyMCESummary form-control text-area"
                      name="summary" id="summary" placeholder="<?php echo trans('summary'); ?> & <?php echo trans("description"); ?> (<?php echo trans('meta_tag'); ?>)" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>><?php echo old('summary'); ?></textarea>
        </div>
		...
		<div class="form-group">
            ...
            <textarea class="form-control text-area inputwordcount"
                      name="tag_description" id="tag_description" word-json='{"word":25,"showID":"tag_description_word","show":1}' placeholder="<?php echo trans('meta_tag'); ?> <?php echo trans("description"); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>><?php echo old('tag_description'); ?></textarea>
        </div>

        <div class="form-group">
            <label class="control-label"><?php echo trans('keywords'); ?> (<?php echo trans('meta_tag'); ?>)</label>
            <textarea class="form-control text-area"
                      name="keywords" id="keywords" placeholder="<?php echo trans('keywords'); ?> (<?php echo trans('meta_tag'); ?>)" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>><?php echo old('keywords'); ?></textarea>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <input id="tags_search" type="text" name="tags" class="form-control tags"/>
