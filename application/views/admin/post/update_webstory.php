            ...
            <div class="col-sm-12">
                <div class="form-post">
                    <div class="form-post-left">
                        <div class="row">
                            <div class="col-sm-12">
                                <?php $this->load->view("admin/post/_form_update_webstory_left"); ?>
                            </div>
                        </div>
                        <?php $this->load->view("admin/post/webstory/_webstory", ['post' => $post, 'post_type' => $post->post_type]); ?>
                    ...
                    <div class="form-post-right">
                        <div class="row">
                            <div class="col-sm-12">
                                <?php $this->load->view('admin/post/_upload_image_box',['post_type' => $post->post_type]); ?>
                            </div>
                            <div class="col-sm-12">
