    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12 form-header">
                <h1 class="form-title"><?php echo trans('add_sorted_list'); ?></h1>
            ...
            <div class="col-sm-12">
                <div class="form-post">
                    <div class="form-post-left">
                        ...
                        <?php $this->load->view("admin/post/_post_list_items", ['title' => trans('sorted_list_items')]); ?>
                    </div>
                    <div class="form-post-right">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <?php $this->load->view('admin/post/_publish_box', ['post_type' => 'sorted_list']); ?>
                            </div>
                        </div>
                    </div>
                </div>
