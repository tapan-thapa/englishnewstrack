    ...
    <div id="panel_list_item_<?php echo $post_list_item->id; ?>" class="panel panel-default panel-list-item" data-list-item-id="<?php echo $post_list_item->id; ?>">
        <div class="panel-heading">
            ...
            <div class="btn-group btn-group-post-list-option" role="group">
                ...
                <?php if(isset($post->post_type) && $post->post_type == 'gallery'){ ?>
                <button type="button" class="btn btn-default" onclick="delete_post_list_item_database('<?php echo $post_list_item->id; ?>','<?php echo $post->post_type ?>','<?php echo trans("confirm_item"); ?>');"><i class="fa fa-trash"></i></button>
                <?php }else{ ?>
                    <button type="button" class="btn btn-default" onclick="delete_post_list_item_database('<?php echo $post_list_item->id; ?>','<?php if(isset($post_list_item->item_post_type)){ echo $post_list_item->item_post_type; } ?>','<?php echo trans("confirm_item"); ?>');"><i class="fa fa-trash"></i></button>
                <?php } ?>
            </div>
        </div>
                                ...
                                <div id="post_list_item_image_container_<?php echo $post_list_item->id; ?>" class="m-b-5">
                                    <div class="list-item-image-container">
                                        <?php if (!empty($post_list_item->image)):
                                            ...
                                            if ($post_list_item->storage == "aws_s3") {
                                            ...
                                            <input type="hidden" name="list_item_image_storage_<?php echo $post_list_item->id; ?>" value="<?php echo $post_list_item->storage; ?>">
                                            <img src="<?= $img_base_url . $post_list_item->image; ?>" alt="">
