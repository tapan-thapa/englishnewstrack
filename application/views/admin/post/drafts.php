            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" role="grid">
                        <?php $this->load->view('admin/includes/_filter_posts',['filter_page'=>"drafts_posts",'categoryTree'=>$categoryTree]); ?>
                        <thead>
                        <tr role="row">
                        ...
                        <?php foreach ($posts as $item): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="post_type" value="<?php echo html_escape($item->post_type); ?>">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu options-dropdown">
                                            ...
                                            <li>
                                                <a href="<?php echo admin_url(); ?>update-post/<?php echo html_escape($item->id); ?>?type=<?php echo $item->post_type; ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                            </li>
                                            <li>
