    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control text-area inputwordcount"
                      name="title" id="wr_input_post_title" word-json='{"word":25,"showID":"wr_input_post_title_word","show":1}' maxlength="120" placeholder="<?php echo trans('title'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> required><?php echo html_escape($post->title); ?></textarea>
