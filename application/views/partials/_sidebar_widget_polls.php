                ...
                <?php if ($poll->vote_permission == "all"): ?>
                    <div id="poll_<?php echo $poll->id; ?>" class="poll">
                        ...
                        <div class="question">
                            <form data-form-id="<?php echo $poll->id; ?>" class="poll-form" method="post">
                                ...
                                <p class="button-cnt">
                                    ...
                                    <a title="<?php echo trans("view_results"); ?>" onclick="view_poll_results('<?php echo $poll->id; ?>');" class="a-view-results"><?php echo trans("view_results"); ?></a>
                                </p>
                        ...
                        <div class="result" id="poll-results-<?php echo $poll->id; ?>">
                            ...
                            <p>
                                <a title="<?php echo trans("view_options"); ?>" onclick="view_poll_options('<?php echo $poll->id; ?>');" class="a-view-results m-0"><?php echo trans("view_options"); ?></a>
                            </p>
                        </div>
                            ...
                            <form data-form-id="<?php echo $poll->id; ?>" class="poll-form" method="post">
                                ...
                                <?php else: ?>
                                    <p class="button-cnt">
                                        ...
                                        <a title="<?php echo trans("view_results"); ?>" href="#" class="a-view-results" data-toggle="modal" data-target="#modal-login"><?php echo trans("view_results"); ?></a>
                                    </p>
                                <?php endif; ?>
                                <div id="poll-required-message-<?php echo $poll->id; ?>" class="poll-error-message">
                                    <?php echo trans("please_select_option"); ?>
