        ...
        foreach ($subcategories as $subcategory):
            if ($i < 5): ?>
                <li role="presentation">
                    <a title="<?php echo html_escape($subcategory->name); ?>" href="#<?php echo html_escape($subcategory->name_slug); ?>-<?php echo html_escape($subcategory->id); ?>" role="tab" data-toggle="tab">
        ...
        <div class="dropdown-menu sub-block-dropdown pull-right">
            <ul id="<?php echo "tabs-" . html_escape($category->name_slug) . "-" . $category->id; ?>" class="nav nav-tabs pull-right" role="tablist">
                ...
                <?php foreach ($subcategories as $subcategory): ?>
                    <li role="presentation">
                        <a title="<?php echo html_escape($subcategory->name); ?>" href="#<?php echo html_escape($subcategory->name_slug); ?>-<?php echo $subcategory->id; ?>" role="tab" data-toggle="tab"><?php echo html_escape($subcategory->name); ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
