...
class Core_Controller extends CI_Controller
{
    public function __construct()
    {
        ...
        /* if($_SERVER['HTTP_HOST'] == "eng.newstrack.com" || $_SERVER['HTTP_HOST'] == "english-prod.newstrack.com" || $_SERVER['HTTP_HOST'] == "english.newstrack.com"){
            $this->general_settings->site_lang = 2;
            ...
            $this->general_settings->site_lang = 3;
        } */
...
{
    public function __construct($load_from_page="")
    {
        parent::__construct();
        ...
        if($load_from_page == "home_page"){
            $this->latest_category_posts = get_cached_data('latest_category_posts');
            if (empty($this->latest_category_posts)) {
                $this->latest_category_posts = $this->post_model->get_category_posts_widget($this->selected_lang->id);
    ...
    {
        if(strpos($url,"/photo-stories")){
            $per_page = $this->general_settings->pagination_per_page+1;
        }else{
