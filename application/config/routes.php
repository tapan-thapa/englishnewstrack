...
$route['live-updates'] = 'home_controller/breaking_news';

$route['special-stories'] = 'home_controller/special_stories';
//$route['trending'] = 'home_controller/trending_news';

#$route['sitemap'] = 'home_controller/html_sitemap';
$route['cron-sitemap'] = 'home_controller/update_sitemap';
$route['news-sitemap-daily.xml'] = 'cron_controller/posts_sitemap/daily';
$route['sitemap.xml'] = 'cron_controller/posts_sitemap_generic/all';
$route['photo-stories.xml'] = 'cron_controller/posts_sitemap_generic/webstory';



$route[$routes->posts]['GET'] = 'home_controller/posts';
$route[$routes->gallery_album . '/(:num)']['GET'] = 'home_controller/gallery_album/$1';
$route[$routes->topic . '/(:any)']['GET'] = 'home_controller/topic/$1';
...
//rss routes
$route['(:any).xml']['GET'] = 'home_controller/generate_category_feeds/$1';
...
/* RSS FEED Crwaling */
$route["cron/photo-story-crawling"]['GET'] = 'cron_controller/photo_story_crawling';
$route["cron/photo-story-backup-crawling"]['GET'] = 'cron_controller/photo_story_backup_crawling';
$route["cron/post-backup-crawling"]['GET'] = 'cron_controller/post_backup_crawling';
$route["cron/post-crawling"]['GET'] = 'cron_controller/post_crawling';
$route["cron/category-crawling"]['GET'] = 'cron_controller/category_crawling';
$route["cron/authors-crawling"]['GET'] = 'cron_controller/authors_crawling';
$route["cron/flag-crawling"]['GET'] = 'cron_controller/flag_update_crawling';
$route["cron/backup-controller"]['GET'] = 'backup_controller/backup_restore';
$route["cron/backup-photo-controller"]['GET'] = 'backup_controller/backup_restore_photo';
$route["cron/library-images-crawling"]['GET'] = 'cron_controller/library_images_crawling';
$route["cron/library-images-upload-backup"]['GET'] = 'cron_controller/library_image_upload_backup';
...
$route['post-detail/(:any)']['GET'] = 'post_detail_controller/next_post/$1';


$route['(:any)/(:num)']['GET'] = 'home_controller/gallery_post/$1/$2';

$route['newsletter'] = 'home_controller/newsletter_post';
...
//post
$route[$routes->admin . "/post-newslatter"] = 'post_controller/post_newslatter';
...
$route[$routes->admin . "/trending-posts"] = 'post_controller/trending_posts';
$route[$routes->admin . "/special-posts"] = 'post_controller/special_posts';
$route[$routes->admin . "/breaking-news"] = 'post_controller/breaking_news';
$route[$routes->admin . "/live-news"] = 'post_controller/live_news';
$route[$routes->admin . "/webstories"] = 'post_controller/webstories';

$route[$routes->admin . "/breaking-news-list"] = 'post_controller/breaking_news_list';
...
$route[$routes->admin . "/categories/(:num)"] = 'category_controller/categories/$1';
...
//PTI routes
$route[$routes->admin . "/pti/import"] = 'Common_controller/import_post';

$route[$routes->admin . "/add-tags"] = 'tags_controller/add_tags';
$route[$routes->admin . "/tags-library-listing"] = 'tags_controller/tags_library_listing';
$route[$routes->admin . "/add-quick-links"] = 'tags_controller/add_quick_links';
#$route[$routes->admin . "/widgets"] = 'widget_controller/widgets';
#$route[$routes->admin . "/update-widget/(:num)"] = 'widget_controller/update_widget/$1';
...
$route['photo-stories']['GET'] = 'home_controller/webstory_listing';
$route['short-videos/(:any)-(:num)']['GET'] = 'shortvideos_controller/index/$1/$2';

/*$route['(:any)/(:any)']['GET'] = 'home_controller/subcategory/$1/$2';
$route['(:any)']['GET'] = 'home_controller/any/$1';*/

$route['amp/(:any)/(:any)-(:num)']['GET'] = 'post_detail_controller/amp/$1/$2/$3';
$route['amp/(:any)/(:any)/(:any)-(:num)']['GET'] = 'post_detail_controller/amp/$1/$2/$3/$4';
$route['amp/(:any)/(:any)/(:any)/(:any)-(:num)']['GET'] = 'post_detail_controller/amp/$1/$2/$3/$4/$5';

$route['(:any)/(:any)-(:num)']['GET'] = 'post_detail_controller/any/$1/$2/$3';
$route['(:any)/(:any)/(:any)-(:num)']['GET'] = 'post_detail_controller/any/$1/$2/$3/$4';
$route['(:any)/(:any)/(:any)/(:any)-(:num)']['GET'] = 'post_detail_controller/any/$1/$2/$3/$4/$5';
//$route['(:any)/(:any)-(:num)']['GET'] = 'home_controller/any/$1/$2/$3';

$route['(:any)/(:any)']['GET'] = 'home_controller/subcategory/$1/$2';
$route['(:any)/(:any)/(:any)']['GET'] = 'home_controller/subcategory/$1/$2/$3';//added on 9feb23
$route['(:any)/(:any)/(:any)/(:any)']['GET'] = 'home_controller/subcategory/$1/$2/$3/$4';//added on 9feb23

$route['(:any)']['GET'] = 'home_controller/any/$2/$1';